	...
	}{
		{
			...
			want: &cfn.Template{
				Resources: cfn.Resources{
					...
					"Deployment0":               buildAWSApiGatewayDeployment("baz", []string{"Methodapi0", "Methodapiv10", "Methodapiv1foobar0", "Methodapiv1foobarproxy0"}, false, nil, "", "", false, false, false, 100, 100, 0),
		...
		},
		{
			...
			want: &cfn.Template{
				Resources: cfn.Resources{
					...
					"Deployment0":               buildAWSApiGatewayDeployment("baz", []string{"Methodapi0", "Methodapiv10", "Methodapiv1foobar0", "Methodapiv1foobarproxy0"}, false, nil, "", "", true, true, true, 100, 100, 0),
					"LoadBalancer":              buildAWSElasticLoadBalancingV2LoadBalancer([]string{"sn-foo"}),
					"VPCLink":                   buildAWSApiGatewayVpcLink([]string{"LoadBalancer"}),
					"WAFAcl":                    buildAWSWAFWebACL("REGIONAL", "[]"),
					"WAFAssociation0":           buildAWSWAFWebACLAssociation("baz", 0),
		...
		},
		{
			...
			want: &cfn.Template{
				Resources: cfn.Resources{
					...
					"SecurityGroupIngress0":     buildAWSEC2SecurityGroupIngresses([]string{"sg-foo"}, "10.0.0.0/24", 30123)[0],
					"RestAPI0":                  buildAWSApiGatewayRestAPI([]string{"arn::foo"}, "EDGE", "AWS_IAM", 0, cfn.Ref("AWS::StackName"), []string{"AWS::NoValue"}, ""),
					"Deployment0":               buildAWSApiGatewayDeployment("baz", []string{"Methodapiv1foobarGET0", "Methodapiv1foobarPOST0", "Methodapiv1foolambdaPOST0"}, false, getAPIResources(), "", "", false, false, false, 100, 100, 0),
					"LoadBalancer":              buildAWSElasticLoadBalancingV2LoadBalancer([]string{"sn-foo"}),
					"VPCLink":                   buildAWSApiGatewayVpcLink([]string{"LoadBalancer"}),
				},
				Outputs: map[string]interface{}{
		...
		},
		{
			...
			want: &cfn.Template{
				Resources: cfn.Resources{
					...
					"SecurityGroupIngress0":  buildAWSEC2SecurityGroupIngresses([]string{"sg-foo"}, "10.0.0.0/24", 30123)[0],
					"RestAPI0":               buildAWSApiGatewayRestAPI([]string{"arn::foo"}, "EDGE", "AWS_IAM", 0, cfn.Ref("AWS::StackName"), []string{"AWS::NoValue"}, ""),
					"Deployment0":            buildAWSApiGatewayDeployment("baz", []string{"Methodapiv1foobarGET0", "Methodapiv1foobarPOST0"}, true, getAPIResources(), "0.5", "", false, false, false, 100, 100, 0),
					"LoadBalancer":           buildAWSElasticLoadBalancingV2LoadBalancer([]string{"sn-foo"}),
					"VPCLink":                buildAWSApiGatewayVpcLink([]string{"LoadBalancer"}),
				},
				Outputs: map[string]interface{}{
		...
		},
		{
			...
			want: &cfn.Template{
				Resources: cfn.Resources{
					...
					"Deployment0":                  buildAWSApiGatewayDeployment("baf", []string{"Methodapiv1foobarGET0", "Methodapiv1foobarPOST0"}, false, nil, "", "", false, false, false, 100, 100, 0),
					"Deployment1":                  buildAWSApiGatewayDeployment("baf", []string{"Methodapiv1foobarGET1", "Methodapiv1foobarPOST1"}, false, nil, "", "", false, false, false, 100, 100, 1),
					"LoadBalancer":                 buildAWSElasticLoadBalancingV2LoadBalancer([]string{"sn-foo"}),
					"VPCLink":                      buildAWSApiGatewayVpcLink([]string{"LoadBalancer"}),
		...
		},
		{
			...
			want: &cfn.Template{
				Resources: cfn.Resources{
					...
					"Deployment0":               buildAWSApiGatewayDeployment("baz", []string{"Methodapi0", "Methodapiv10", "Methodapiv1foobar0", "Methodapiv1foobarproxy0"}, false, nil, "", "", false, false, false, 100, 100, 0),
					"Deployment1":               buildAWSApiGatewayDeployment("baz", []string{"Methodapi1", "Methodapiv11", "Methodapiv1foobar1", "Methodapiv1foobarproxy1"}, false, nil, "", "", false, false, false, 100, 100, 1),
					"Deployment2":               buildAWSApiGatewayDeployment("baz", []string{"Methodapi2", "Methodapiv12", "Methodapiv1foobar2", "Methodapiv1foobarproxy2"}, false, nil, "", "", false, false, false, 100, 100, 2),
					"Deployment3":               buildAWSApiGatewayDeployment("baz", []string{"Methodapi3", "Methodapiv13", "Methodapiv1foobar3", "Methodapiv1foobarproxy3"}, false, nil, "", "", false, false, false, 100, 100, 3),
					"LoadBalancer":              buildAWSElasticLoadBalancingV2LoadBalancer([]string{"sn-foo"}),
					"VPCLink":                   buildAWSApiGatewayVpcLink([]string{"LoadBalancer"}),
					"APIKeyUsagePlan000":        getAPIKeyMappingBuild(0, 0, 0),
					"APIKeyUsagePlan010":        getAPIKeyMappingBuild(1, 0, 0),
